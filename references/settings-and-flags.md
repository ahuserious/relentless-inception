...
2. If still failing, try the named fallback (e.g., gpt-5.6 → gpt-latest; opus-latest → opus-4.7).
...
- `OPENROUTER_API_KEY` — required for gpt-5.6, gemini-latest, gpt-pro-latest routes
